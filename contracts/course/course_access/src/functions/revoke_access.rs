...
/// Revokes a user's access to a specific course and updates related storage entries.
///
...
///   or `false` if no access entry was found for the user and course combination.
